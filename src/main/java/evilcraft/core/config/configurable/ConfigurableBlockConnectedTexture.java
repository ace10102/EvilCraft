...
public abstract class ConfigurableBlockConnectedTexture extends ConfigurableBlock {
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
        updateConnections(world, x, y, z);// If there are framerate issues, this will probably be the cause.
     ...
     * If it is true, the renderer will look for getTextureName()+"_inventory" icon,
     * otherwise the background of the block will be taken (without corners, edges and innercorners).
