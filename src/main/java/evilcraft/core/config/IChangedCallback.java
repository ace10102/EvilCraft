 ...
 * Classes implementing this interface can be given to {@link ConfigurableProperty} as a {@link ConfigurableProperty#changedCallback()} field.
 * When that is done, the given class MUST have a default public constructor.
 * @author rubensworks
 */
