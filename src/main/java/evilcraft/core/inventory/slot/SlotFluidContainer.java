...
public class SlotFluidContainer extends Slot {
    ...
    /**
     * Check if the given item is valid and the fluid equals the fluid inside the container (or the fluid in the container is null).
    ...
    public static boolean checkIsItemValid(ItemStack itemStack, SingleUseTank tank) {
        if(itemStack != null && (itemStack.stackSize == 1 || FluidContainerRegistry.drainFluidContainer(itemStack) == null || FluidContainerRegistry.drainFluidContainer(itemStack).stackSize == 0)) {
