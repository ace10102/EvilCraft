...
public interface IBlockTank {
    ...
    /**
     * Get the maximum capacity possible for this item/block type. Only makes sense to have a bigger value than
     * {@link IBlockTank#getTankCapacity(ItemStack)} if this capacity is variable.
