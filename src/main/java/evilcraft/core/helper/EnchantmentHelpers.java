...
public class EnchantmentHelpers {
    ...
    /**
     * Returns the level of an enchantment given an itemStack and the list id of the enchantment in the enchantmentlist
     * (see doesEnchantApply() to get the id in the enchantmentlist)
    ...
    /**
     * Returns the id of an enchantment given an itemStack and the list id of the enchantment in the enchantmentlist
     * (see doesEnchantApply() to get the id in the enchantmentlist)
     * @param itemStack The itemStack which contains the enchanted item
     * @param enchantmentListID The id of the enchantment in the enchantment list
    ...
    /**
     * Sets the level of an enchantment given an itemStack and the id of the enchantment in the enchantmentlist
     * (see doesEnchantApply() to get the id in the enchantmentlist)
