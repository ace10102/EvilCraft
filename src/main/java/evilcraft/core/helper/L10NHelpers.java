...
public final class L10NHelpers {
     ...
     * @param statusPrefixKey The prefix for the l10n key that will show if it is enabled, this should be a formatted string with one parameter.
     */
    ...
    public static void addOptionalInfo(List list, String prefix) {
        ...
        if(StatCollector.canTranslate(key)) {
            if(MinecraftHelpers.isShifted()) {
                ...
                list.add(localize(EnumChatFormatting.GRAY.toString() + EnumChatFormatting.ITALIC.toString() + localize("general.tooltip.info")));
            }
        }
    }
}