...
public interface IRetroGen {
     ...
     * The NBT compound tag is specific for retrogeneration and contains data that is stored in {@link IRetroGen#afterRetroGen(NBTTagCompound)}.
     ...
     * Info should be stored inside the given tag about the retrogen status, so that it can be re-used later in {@link IRetroGen#shouldRetroGen(NBTTagCompound, int)}.
