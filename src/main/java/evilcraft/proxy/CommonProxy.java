...
public class CommonProxy {
    ...
    /**
     * Play a minecraft sound, will do nothing serverside, use
     * {@link CommonProxy#sendSound(double, double, double, String, float, float, String)} for this.
    ...
    /**
     * Play a sound, will do nothing serverside, use
     * {@link CommonProxy#sendSound(double, double, double, String, float, float, String)} for this.
     * @param x The X coordinate.
     * @param y The Y coordinate.
     * @param z The Z coordinate.
    ...
    /**
     * Play an evilcraft sound, will do nothing serverside, use
     * {@link CommonProxy#sendSound(double, double, double, String, float, float, String)} for this.
     * @param x The X coordinate.
     * @param y The Y coordinate.
     * @param z The Z coordinate.
