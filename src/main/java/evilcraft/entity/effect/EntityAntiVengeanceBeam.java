...
public class EntityAntiVengeanceBeam extends EntityThrowable implements IConfigurable {
    ...
    public void onUpdate() {
        ...
        if(!this.worldObj.isRemote) {
            ...
            if(soundTick == 1) {
                // Play beam sound
                EvilCraft.proxy.playSound(posX, posY, posZ, "vengeanceBeam", 0.5F + worldObj.rand.nextFloat() * 0.2F, 1.0F);
            }
        }
    ...
    private void showNewBlurParticle() {
        ...
        EntityBlurFX blur = new EntityBlurFX(worldObj, posX, posY, posZ, scale, deriveMotion(motionX), deriveMotion(motionY), deriveMotion(motionZ), red, green, blue, ageMultiplier);
