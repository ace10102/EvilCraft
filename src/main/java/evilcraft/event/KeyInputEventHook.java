...
public class KeyInputEventHook {
    ...
    /**
     * Binds a {@link KeyHandler} to key presses of the specified {@link KeyBinding}.
     * Whenever the {@link KeyBinding} is pressed, {@link KeyHandler#onKeyPressed(KeyBinding)} is called.
