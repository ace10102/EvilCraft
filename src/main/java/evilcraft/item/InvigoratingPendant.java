...
public class InvigoratingPendant extends ConfigurableDamageIndicatedItemFluidContainer implements IBauble {
    ...
    /**
     * Clear the bad effects of given player. Each 'tick', a certain amount of bad effect duration reduction is reserved.
     * Each found effect it's duration is reduced by as much as possible (not larger than the reserved amount) and the inner
     * tank is drained according to how much was reduced.
