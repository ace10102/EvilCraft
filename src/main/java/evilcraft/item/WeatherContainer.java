...
public class WeatherContainer extends ConfigurableItem {
    ...
    /**
     * Checks whether or not a WeatherContainer is empty (it does not contain any weather) given its item damage
    ...
    /**
     * Returns the weather container type for a weather container with the given item damage
    ...
    /**
     * Returns the weather container type for the weather container in the given ItemStack
    ...
    public enum WeatherContainerTypes {
        ...
        /**
         * Returns the WeatherContainerType corresponding to the given WeatherType.
