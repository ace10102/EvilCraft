...
public class EntangledChaliceConfig extends BlockContainerConfig {
    ...
    public void onRegistered() {
        if(MinecraftHelpers.isClientSide()) {
            ...
            ClientProxy.TILE_ENTITY_RENDERERS.put(TileEntangledChalice.class, new RenderTileEntityEntangledChalice(model, texture));
            ClientProxy.ITEM_RENDERERS.put(Item.getItemFromBlock(EntangledChalice.getInstance()), new RenderItemEntangledChalice(model, texture));
        }
    }
}