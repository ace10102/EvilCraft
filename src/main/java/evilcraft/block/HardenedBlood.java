...
public class HardenedBlood extends ConfigurableBlockConnectedTexture {
    ...
    private void splitBlock(World world, int x, int y, int z) {
        ItemStack itemStack = new ItemStack(HardenedBloodShardConfig._instance.getItemInstance(),
                HardenedBloodShardConfig.minimumDropped + (int)(Math.random() * (double)HardenedBloodShardConfig.additionalDropped));
