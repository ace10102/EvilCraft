...
public class RenderTileEntityBoxOfEternalClosure extends RenderTileEntityModel {
    ...
    private static final ResourceLocation beamTexture = new ResourceLocation(Reference.MOD_ID, Reference.TEXTURE_PATH_ENTITIES + "beam.png");
    ...
    protected void renderTileEntityAt(EvilCraftTileEntity tile, double x, double y, double z, float partialTick) {
        ...
        if(target != null) {
            ...
            float v1 = MathHelper.sqrt_float(rotateX * rotateX + rotateY * rotateY + rotateZ * rotateZ) / 32.0F - ((float)target.ticksExisted + partialTick) * 0.01F;
