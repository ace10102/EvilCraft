...
public class RenderTileEntityEnvironmentalAccumulator extends RenderTileEntityBeacon {
    ...
    private void renderProcessingItem(IRecipe<EnvironmentalAccumulatorRecipeComponent, EnvironmentalAccumulatorRecipeComponent,
            EnvironmentalAccumulatorRecipeProperties> recipe, World world, float partialTickTime) {
