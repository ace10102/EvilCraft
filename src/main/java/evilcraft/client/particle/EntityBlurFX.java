...
/**
 * A blurred static fading particle with any possible color. Based on Vazkii's FXWisp's from Botania.
 * @author rubensworks
 */
public class EntityBlurFX extends EntityFX {
     ...
     * @param ageMultiplier The multiplier of the maximum age (this will be multiplied with a partially random factor).
     */
    public EntityBlurFX(World world, double x, double y, double z, float scale, double motionX, double motionY, double motionZ, float red, float green, float blue, float ageMultiplier) {
