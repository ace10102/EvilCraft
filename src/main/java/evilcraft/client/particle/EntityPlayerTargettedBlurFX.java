...
/**
 * A blurred static fading particle with any possible color targeted at a certain player.
 * @author rubensworks
 */
public class EntityPlayerTargettedBlurFX extends EntityBlurFX {
     ...
     * @param player The player to target a partially random factor).
     */
    public EntityPlayerTargettedBlurFX(World world, float scale, double motionX, double motionY, double motionZ, float red, float green, float blue, float ageMultiplier, EntityPlayer player) {
