...
/**
 * Enum that contains all custom hotkeys that are added by EvilCraft.
 * Every key also has a {@link KeyBinding} for that specific key.
 * @author immortaleeb
 */
public enum Keys {
    ...
    /**
     * Short helper function for translating key descriptions and categories.
     ...
     * Whenever this key is pressed, {@link KeyHandler#onKeyPressed(KeyBinding)} will be called with the {@link KeyBinding} linked to this specific key.
